...
public :
  ...
  */
  ...
  //pis ghost prob bins;
  TH1D* dst_mass_pis_ghostprob_bin1_pos;
  TH1D* dst_mass_pis_ghostprob_bin2_pos;
  TH1D* dst_mass_pis_ghostprob_bin3_pos;
  TH1D* dst_mass_pis_ghostprob_bin4_pos;
  TH1D* dst_mass_pis_ghostprob_bin5_pos;
  TH1D* dst_mass_pis_ghostprob_bin6_pos;
  TH1D* dst_mass_pis_ghostprob_bin7_pos;
  TH1D* dst_mass_pis_ghostprob_bin8_pos;
  TH1D* dst_mass_pis_ghostprob_bin9_pos;
  TH1D* dst_mass_pis_ghostprob_bin10_pos;
  TH1D* dst_mass_pis_ghostprob_bin11_pos;
  TH1D* dst_mass_pis_ghostprob_bin12_pos;
  TH1D* dst_mass_pis_ghostprob_bin13_pos;
  TH1D* dst_mass_pis_ghostprob_bin14_pos;
  TH1D* dst_mass_pis_ghostprob_bin15_pos;
  TH1D* dst_mass_pis_ghostprob_bin16_pos;
  TH1D* dst_mass_pis_ghostprob_bin17_pos;
  TH1D* dst_mass_pis_ghostprob_bin18_pos;
  TH1D* dst_mass_pis_ghostprob_bin19_pos;
  TH1D* dst_mass_pis_ghostprob_bin20_pos;
  //negative
  TH1D* dst_mass_pis_ghostprob_bin1_neg;
  TH1D* dst_mass_pis_ghostprob_bin2_neg;
  TH1D* dst_mass_pis_ghostprob_bin3_neg;
  TH1D* dst_mass_pis_ghostprob_bin4_neg;
  TH1D* dst_mass_pis_ghostprob_bin5_neg;
  TH1D* dst_mass_pis_ghostprob_bin6_neg;
  TH1D* dst_mass_pis_ghostprob_bin7_neg;
  TH1D* dst_mass_pis_ghostprob_bin8_neg;
  TH1D* dst_mass_pis_ghostprob_bin9_neg;
  TH1D* dst_mass_pis_ghostprob_bin10_neg;
  TH1D* dst_mass_pis_ghostprob_bin11_neg;
  TH1D* dst_mass_pis_ghostprob_bin12_neg;
  TH1D* dst_mass_pis_ghostprob_bin13_neg;
  TH1D* dst_mass_pis_ghostprob_bin14_neg;
  TH1D* dst_mass_pis_ghostprob_bin15_neg;
  TH1D* dst_mass_pis_ghostprob_bin16_neg;
  TH1D* dst_mass_pis_ghostprob_bin17_neg;
...
DT_D0_mix_CPV::DT_D0_mix_CPV(TTree *tree) : fChain(0) 
{
  ...
  d0_mass_plot_sig_rej = new TH1D(name+"_dt_d0_m_sig_rej","",400,1700.,2100.);
  d0_mass_plot_sig_rej->SetTitle(Form("m(K#pi)[MeV];m(K#pi)[MeV];Entries/%.2f",d0_mass_plot->GetBinWidth(1)));
  ...
  td0_bin_neg075_to_neg05->SetTitle(Form("m(D^{0}#pi_{S}), -0.75#leq t(D^{0})/#tau<-0.5;m(D^{0}#pi_{s}[MeV];Entries/%.2f MeV",td0_bin_neg075_to_neg05->GetBinWidth(1)));
   ...
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin1_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin2_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin3_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin4_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin5_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin6_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin7_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin8_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin9_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin10_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin11_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin12_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin13_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin14_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin15_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin16_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin17_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin18_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin19_pos);
   the_ghost_prob_bins_pos.push_back(dst_mass_pis_ghostprob_bin20_pos);
   //neg
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin1_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin2_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin3_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin4_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin5_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin6_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin7_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin8_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin9_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin10_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin11_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin12_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin13_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin14_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin15_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin16_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin17_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin18_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin19_neg);
   the_ghost_prob_bins_neg.push_back(dst_mass_pis_ghostprob_bin20_neg);
   ...
   for(int i=0; i<20;++i){
     the_ghost_prob_bins_pos[i] = new TH1D(name+Form("_dst_mass_pis_ghostprob_bin%d_pos",i+1),"",500,2000,2025);
     the_ghost_prob_bins_pos[i]->SetTitle(Form("m(D^{0}#pi_{s}); m(D^{0}#pi_{s})[MeV]; Entries/%.2f MeV",the_ghost_prob_bins_pos[i]->GetBinWidth(1)));
