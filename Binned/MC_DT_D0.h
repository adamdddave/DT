...
// Thu Apr 30 13:51:46 2015 by ROOT version 6.02/05
// from TTree DecayTree/DecayTree
// found on file: /afs/cern.ch/user/a/adavis//eos/lhcb/user/a/adavis/DT_ana_signalMC_pythia8/DVTuples_Pythia8_SignalMC.root
//////////////////////////////////////////////////////////
...
#ifdef MC_DT_D0_cxx
MC_DT_D0::MC_DT_D0(TTree *tree) : fChain(0) 
{
  // if parameter tree is not specified (or zero), connect the file
  // used to generate this class and read the Tree.
  if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/a/adavis//eos/lhcb/user/a/adavis/DT_ana_signalMC_pythia8/DVTuples_Pythia8_SignalMC.root");
    if (!f || !f->IsOpen()) {
      f = new TFile("/afs/cern.ch/user/a/adavis//eos/lhcb/user/a/adavis/DT_ana_signalMC_pythia8/DVTuples_Pythia8_SignalMC.root");
    }
    TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/user/a/adavis//eos/lhcb/user/a/adavis/DT_ana_signalMC_pythia8/DVTuples_Pythia8_SignalMC.root:/RS");
    dir->GetObject("DecayTree",tree);

  }
  Init(tree);
  dstar_mass_resolution_plot = new TH1D("dt_dstar_mass_res","", 200, -100,100);
...
Int_t MC_DT_D0::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t MC_DT_D0::LoadTree(Long64_t entry)
{
...
void MC_DT_D0::Show(Long64_t entry)
{
...
Int_t MC_DT_D0::Cut(Long64_t entry)
{
